<template>
  ...
  <div class="vinylStyle" v-else>    
   ...
   <!--  <audio :src="songSrc" autoplay="" controls="" style='margin-left:200px;position:fixed;z-index:9999'></audio>     -->
  </div>
</template>
<script>
export default {
...
.cdStyle .cd{ -webkit-mask: radial-gradient(transparent, transparent 70px, rgba(255, 255, 255, .4) 72px, #000 72px);
  mask: radial-gradient(transparent 70px, rgba(255, 255, 255, .4) 72px, #000 72px);}
.vinylStyle .cdBox::after{border: none;width: 34px;height: 34px; box-shadow: -2px 0px 15px rgba(0, 0, 0, .3) inset, -1px 1px 0px rgba(255,255,255,.25), 0px 0px 0px rgba(255,255,255,.3) inset}
.vinylStyle .cdShadow{background-image: none; box-shadow: -2px -1px 20px rgba(0,0,0,.8);}
.cdBox::after {  
  content: '';
  width: 72px;
  height: 72px;
